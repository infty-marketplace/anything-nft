<template>
    <div>
        <div class="drag-area">
            <input ref='input' accept=".jpg,.jpeg,.png" hidden type="file" @change="onUpload"/>
            <img v-if="fileLoaded" ref='image' style="object-fit: contain"/>
            <div v-else class='drag-area-inner mt-5'>
                <svg
        ...
        <button v-if="fileLoaded" style="float: right" @click="btnClicked">
