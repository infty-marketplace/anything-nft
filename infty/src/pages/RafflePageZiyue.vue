    ...
    <div class="raffle-page">
        ...
        <div>
            ...
            >
                ...
                >
                <b-button v-else class="buy-btn" id="modal-buy" variant="primary" @click="buyNowClicked"
                    >Buy Now</b-button
                >
            </b-modal>
            ...
            >
                ...
                <div class="mt-4" v-for="raffle in raffles" :key="raffle.nft_id">
                    <b-card :img-src="raffle.url" img-alt="Card image" img-left class="mb-3 pool-card">
                            ...
                            <div class="transaction-primary">
                                <div class="price">
                                    <b-badge
                                        ...
                                        >{{ new Date(raffle.deadline * 1000).toLocaleDateString() }}</b-badge
                                    >
                                    <b-badge
                                        v-else
                                    ...
                                    <b-badge class="price-item price-badge" style="background-color: rgb(236, 105, 166)"
                                        >{{ raffle.unit_price }} {{ raffle.currency }}</b-badge
                                    >
                                </div>
                                <b-progress :value="20" variant="info" :animated="animate" class="mt-3"></b-progress>
